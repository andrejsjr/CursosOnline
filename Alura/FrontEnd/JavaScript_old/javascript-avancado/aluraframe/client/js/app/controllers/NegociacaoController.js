                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function _init() {
                        ...
                        this._service.lista().then(function (negociacoes) {
                            ...
                            _this._erroBusca = true;
                            _this._mensagem.texto = 'Não foi possível buscar negociações.';
                        });

                        setInterval(function () {
                            if (!_this._erroImportacao && !_this._erroBusca) _this.importaNegociacoes();
                        }, 3000);
                    }
                }, {
                    key: '_criaNegociacao',
                    ...
                    value: function importaNegociacoes() {
                        ...
                        this._service.importa(this._listaNegociacoes.negociacoes).then(function (negociacoes) {
                            ...
                            _this3._erroImportacao = true;
                            _this3._mensagem.texto = 'Não foi possível importar negociações.';
                        });
                    }
                }, {
                    key: 'apaga',
                    value: function apaga() {
                        ...
                        this._service.apaga().then(function (mensagem) {
                            _this4._listaNegociacoes.apaga();
